			...
			<div class="col-10">
				<div class="container">
				    ...
				    <div class="row">
				        ...
				        <c:choose>
				        <c:when test="${data.fundingVo.funding_status eq 'Approved'}">
				        <div class="col-md-3 col-sm-6">
				            <div class="funding-grid">
				                <div class="funding-image">
				                    <a href="${pageContext.request.contextPath}/funding/read_funding_page.do?funding_open_no=${data.fundingVo.funding_open_no}">
				                        <img class="pic" src="${data.fundingVo.funding_thumb}" height="150">
				                    </a>
				                </div>
				            </div>
				        </div>
						...
						<div class="col">
							<nav aria-label="Page navigation example">
								<ul class="pagination mb-0 pagination justify-content-center">
									<li class="page-item<c:if test="${currentPage == 1 }"> disabled</c:if>"><a href="${pageContext.request.contextPath}/funding/tobeopen_funding_main_page.do?page_num=1" class="page-link">&lt;&lt;</a></li>
									<li class="page-item<c:if test="${beginPage <= 1 }"> disabled</c:if>"><a href="${pageContext.request.contextPath}/funding/tobeopen_funding_main_page.do?page_num=${beginPage-1 }" class="page-link">&lt;</a></li>
									<c:forEach begin="${beginPage}" end="${endPage }" var="i">
										<li class="page-item<c:if test="${i == currentPage }"> active</c:if>"><a href="${pageContext.request.contextPath}/funding/tobeopen_funding_main_page.do?page_num=${i }" class="page-link">${i }</a></li>
									</c:forEach>
									<li class="page-item<c:if test="${endPage >= pageCount }"> disabled</c:if>"><a href="${pageContext.request.contextPath}/funding/tobeopen_funding_main_page.do?page_num=${endPage+1 }" class="page-link">&gt;</a></li>
									<li class="page-item<c:if test="${currentPage == pageCount }"> disabled</c:if>"><a href="${pageContext.request.contextPath}/funding/tobeopen_funding_main_page.do?page_num=${pageCount }" class="page-link">&gt;&gt;</a></li>
								</ul>
							</nav>
						</div>
						<div class="col-4">
							<form action="${pageContext.request.contextPath }/funding/tobeopen_funding_main_page.do" method="get">
