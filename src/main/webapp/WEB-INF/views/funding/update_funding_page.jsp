				      ...
				      <div class="col-md-7 col-lg-8">
				        ...
				        <form id="frm1" class="needs-validation" action="${pageContext.request.contextPath}/funding/update_funding_process.do" method="post" enctype="multipart/form-data">
					      ...
					      <div class="row gy-3">
					       		...
					       		<div class="mt-3"><label for="thumb" class="form-label">대표 이미지 설정</label></div>
					       	</div>
					       	<div class="col-12-mb-4">
				          ...
				          <button class="w-100 btn btn-outline-primary btn-lg" type="button" onclick="formSubmit()">수정 완료</button>
				          </div>
				        </form>
				      </div>
				    </div>
