    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        <table class="table table-hover">
							...
							<tbody>
								<c:forEach items="${qnaAdminResultList }" var="data">
									<tr>
									...
									<c:choose>
										<c:when test="${!empty data.qnaVo.qna_reply}">
											<td><a class="link-dark mr-2" href="${pageContext.request.contextPath }/admin/add_qna_reply_page.do?qna_no=${data.qnaVo.qna_no}">${data.qnaVo.qna_title }<span id="span" class="badge rounded-pill bg-danger">check!</span></a></td>	
										</c:when>
										<c:otherwise>
											<td><a class="link-dark" href="${pageContext.request.contextPath }/admin/add_qna_reply_page.do?qna_no=${data.qnaVo.qna_no}">${data.qnaVo.qna_title }</a></td>
										</c:otherwise>
									</c:choose>
