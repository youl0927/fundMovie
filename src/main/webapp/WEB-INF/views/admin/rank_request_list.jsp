        ...
        <table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="text-center" width="100">계좌정보</th>
									<th class="text-center" width="100">E-mail.</th>
									<th class="text-center" width="150">등업 신청일</th>
									<th class="text-center" width="150">최근 접속시간</th>
									<th class="text-center" width="50">승인</th>
								</tr>
							</thead>
							<tbody>
							
								<c:forEach items="${rankList}" var="data" >
									<tr>
										<td class="text-center">${data.memberVo.user_nick }</td>
										<td class="text-center">${data.memberVo.user_id }</td>
										<td class="text-center">${data.memberVo.user_account }</td>
										<td class="text-center">${data.memberVo.user_email }</td>
										<td class="text-center"><fmt:formatDate value="${data.rankUpRequestVo.rank_up_request_date }" pattern="yyyy.MM.dd HH:mm:ss" /></td>
										<td class="text-center">1</td>
									<c:choose>
										<c:when test="${data.memberVo.user_author eq '펀드유저' }">
											<td class="text-center"><a href="#"><img src="${pageContext.request.contextPath }/resources/image/check-circle-fill.svg" width="20" height="20" class="d-block w-100" alt="..."></a></td>
										</c:when>
										<c:otherwise>
											<td class="text-center"><a href="${pageContext.request.contextPath}/admin/approve_rank_process.do?user_no=${data.memberVo.user_no }"><img src="${pageContext.request.contextPath }/resources/image/check-circle.svg" width="20" height="20" class="d-block w-100" alt="..."></a></td>
										</c:otherwise>
									</c:choose>	
